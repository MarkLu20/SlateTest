...
TSharedRef<ITableRow> UMkTreeView::OnGenerateItemRow(TSharedRef<FMkTreeViewItemInternal> InItem, const TSharedRef<STableViewBase>& OwnerTable)
{
	...
	TArray<FSlateBrush> Expanders = TArray<FSlateBrush>();
	Expanders.Add(Expander);
	Expanders.Add(ExpanderHover);
	Expanders.Add(Collapsed);
	Expanders.Add(CollapsedHover);

	return
		SNew(SMkTreeRow< TSharedRef<FString> >, OwnerTable, Expanders,  ExpanderPadding)
