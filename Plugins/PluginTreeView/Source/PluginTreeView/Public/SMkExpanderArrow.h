...
public:
	...
	void Construct( const FArguments& InArgs, const TSharedPtr<class ITableRow>& TableRow, TArray<FSlateBrush>& expander,  FMargin& expanderPadding);
